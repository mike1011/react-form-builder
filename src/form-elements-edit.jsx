    ...
    return (
      <div>
        ...
        {this.props.element.hasOwnProperty("file_path") && (
          <div className="form-group">
            <label className="control-label control-edit" htmlFor="fileSelect">
              Choose file:
            </label>
            <select
              id="fileSelect"
        ...
        this.props.element.readOnly ? (
          <div className="form-group">
            <label className="control-label control-edit" htmlFor="variableKey">
              Variable Key:
            </label>
            <input
              id="variableKey"
        ...
        {canHavePageBreakBefore && (
          <div className="form-group">
            <label className="control-label control-edit">Print Options</label>
            <div className="custom-control custom-checkbox">
              <input
        ...
        {this.props.element.hasOwnProperty("step") && (
          <div className="form-group">
            <div className="form-group-range">
              <label className="control-label control-edit" htmlFor="rangeStep">
                Step
              </label>
              <input
                id="rangeStep"
        ...
        {this.props.element.hasOwnProperty("min_value") && (
          <div className="form-group">
            <div className="form-group-range">
              <label className="control-label control-edit" htmlFor="rangeMin">
                Min
              </label>
              <input
                id="rangeMin"
        ...
        {this.props.element.hasOwnProperty("max_value") && (
          <div className="form-group">
            <div className="form-group-range">
              <label className="control-label control-edit" htmlFor="rangeMax">
                Max
              </label>
              <input
                id="rangeMax"
